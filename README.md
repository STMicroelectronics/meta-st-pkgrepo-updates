...
3. Clone the meta-jupyter repository:
  ...
  PC $> sed -i 's/langdale/langdale mickledore scarthgap/' meta-jupyter/conf/layer.conf
  ```
...
- apt-openstlinux-x-linux-ai-cpu 6.2.0-r0: apt configuration for X-LINUX-AI CPU packages
- apt-openstlinux-x-linux-ai-npu 6.2.0-r0: apt configuration for X-LINUX-AI NPU packages
...
- node-red 4.1.2-r0: add support for Node-RED programming
- node-red-dasboard 3.6.6-r0: add a set of dashboard nodes for Node-RED. This library is deprecated and may be removed without notice
...
- node-red-node-sqlite 1.1.1-r0: add a sqlite node for Node-RED
- openvpn-install 1.0-r0: ease OpenVPN server installation
- python3-amqp 5.3.1-r0: AMQP Client library
- python3-azure-core 1.36.0-r0: provide Azure core shared client library
- python3-azure-identity 1.24.0-r0: Azure identity library
- python3-azure-servicebus 7.14.2-r0: Azure service bus client library
- python3-azure-storage-blob 12.27.1-r0: Azure storage blobs client library
- python3-ixnetwork-restpy 1.8.0-r0: IxNetwork REST API client
- python3-msal 1.34.0-r0: Microsoft authentication library
- python3-msal-extensions 1.3.1-r0: Microsoft authentication library extensions
- python3-msrest 0.7.1-r0: AutoRest swagger generator client runtime
- python3-pyjwt 2.10.1-r0: JSON Web Token implementation in Python
...
- x-linux-ai-tool 6.2.0-r0: provide X-LINUX-AI installer tool
