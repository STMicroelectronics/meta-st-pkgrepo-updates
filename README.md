...
- python3-azure-core 1.30.2-r0: provide Azure core shared client library
- python3-azure-identity 1.17.1-r0: Azure identity library
...
- python3-pyjwt 2.9.0-r0: JSON Web Token implementation in Python
